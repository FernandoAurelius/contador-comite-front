...
const __VLS_0 = {}.RangeCalendarGrid;
/** @type {[typeof __VLS_components.RangeCalendarGrid, typeof __VLS_components.RangeCalendarGrid, ]} */ ;
// @ts-ignore
const __VLS_1 = __VLS_asFunctionalComponent(__VLS_0, new __VLS_0({
    dataSlot: "range-calendar-grid",
    ...{ class: (__VLS_ctx.cn('w-full border-collapse space-x-1', props.class)) },
...
//# sourceMappingURL=RangeCalendarGrid.vue.js.map